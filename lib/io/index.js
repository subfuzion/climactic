...
io.suggest = function () {
  ...
  io.print(colors.normal('    - %s'), colors.terminal(text));
};
...
io.printBanner = function (title, subtitle, font) {
  var indent = createIndent(8),
      nodeVer = process.version;

  io.print(colors.app(figlet.textSync('  ' + title, {
    font: font || 'Standard',
  ...
  io.write(indent);
  io.print(colors.terminal(subtitle));
  io.print();
};
